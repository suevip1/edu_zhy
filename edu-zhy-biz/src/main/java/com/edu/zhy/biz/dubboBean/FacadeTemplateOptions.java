...
public class FacadeTemplateOptions {
    ...
    public static FacadeTemplateOptionsBuilder builder() {
        return new FacadeTemplateOptionsBuilder();
    }
    ...
    public static class FacadeTemplateOptionsBuilder {
        ...
        public FacadeTemplateOptionsBuilder withTransaction(final boolean withTransaction) {
            this.withTransaction = withTransaction;
            this.withTransaction$set = true;
            return this;
        }

        public FacadeTemplateOptionsBuilder retryStrategy(final RetryStrategy retryStrategy) {
            this.retryStrategy = retryStrategy;
            this.retryStrategy$set = true;
            return this;
        }

        public FacadeTemplateOptionsBuilder exceptionHandler(final ExceptionHandler exceptionHandler) {
            this.exceptionHandler = exceptionHandler;
