...
public class ClientTemplateOptions {
    ...
    public static ClientTemplateOptionsBuilder builder() {
        return new ClientTemplateOptionsBuilder();
    }
    ...
    public static class ClientTemplateOptionsBuilder {
        ...
        public ClientTemplateOptionsBuilder resultMapper(final Function<Object, Object> resultMapper) {
            this.resultMapper = resultMapper;
            this.resultMapper$set = true;
            return this;
        }

        public ClientTemplateOptionsBuilder retryStrategy(final RetryStrategy retryStrategy) {
            this.retryStrategy = retryStrategy;
            this.retryStrategy$set = true;
            return this;
        }

        public ClientTemplateOptionsBuilder exceptionHandler(final ExceptionHandler exceptionHandler) {
            this.exceptionHandler = exceptionHandler;
            this.exceptionHandler$set = true;
            return this;
        }

        public ClientTemplateOptionsBuilder exceptionResultMapper(final Function<Throwable, Object> exceptionResultMapper) {
            this.exceptionResultMapper = exceptionResultMapper;
