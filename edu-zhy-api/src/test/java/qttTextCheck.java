...
//            String fileResult = "C:\\Users\\Admin\\IdeaProjects\\edu_zhy\\edu-zhy-api\\src\\main\\java\\com\\edu\\zhy\\api\\api\\excel\\sensitiveWordsFilter.txt";
            ...
            String fileResult = "C:\\Users\\Admin\\Desktop\\qtt搬家\\强哥启蒙-129738707\\强哥启蒙-129738707 - 副本.json";
...
//        System.err.println(substring1+substring);
    ...
    public void updateGoodId(){
        ...
        try {
            ...
            String sourceFile = "C:\\Users\\Admin\\Desktop\\qtt搬家\\品牌家具账号-132136062\\品牌家具账号-132136062 （2）.json";
            String fileResult = "C:\\Users\\Admin\\Desktop\\qtt搬家\\品牌家具账号-132136062\\品牌家具账号-132136062 （2） - 副本.json";
...
//                    jsonObject1.put("goods_name",goods_name + "31009"+i);
    ...
    public void writeText(){
        ...
        try {
            ...
            String sourceFile = "C:\\Users\\Admin\\Desktop\\qtt搬家\\Crystal的杂烩铺-41315682\\Crystal的杂烩铺-41315682.json";

            String fileResult = "C:\\Users\\Admin\\Desktop\\qtt搬家\\Crystal的杂烩铺-41315682\\Crystal的杂烩铺-41315682 - 副本.json";


            String fileResultv1 = "C:\\Users\\Admin\\Desktop\\qtt搬家\\Crystal的杂烩铺-41315682\\Crystal的杂烩铺-41315682 - 副本 (2).json";


            String fileResultv2 = "C:\\Users\\Admin\\Desktop\\qtt搬家\\Crystal的杂烩铺-41315682\\Crystal的杂烩铺-41315682 - 副本 (3).json";
            ...
            FileWriter writerv2 = new FileWriter(fileResultv2, true);
...
//                JSONObject jsonObject = JSON.parseObject(line);
                ...
                if (stringList.size() > 900 && stringList.size() < 1800){
                    writerv1.write(line);
                    writerv1.write("\n");
                }

                if (stringList.size() >  1800){
                    writerv2.write(line);
                    writerv2.write("\n");
                }
    ...
    public void checkGoodsInfoWithSkuVoListSize(){
        ...
        try {
            ...
            String sourceFile = "C:\\Users\\Admin\\Desktop\\qtt搬家\\豐登田園一站式宅配-149275021\\豐登田園一站式宅配-149275021.json";
...
//            writer.close();
    ...
    public void deletedGoodsInfoWithSkuVoListSize(){
        ...
        try {
            ...
            String sourceFile = "C:\\Users\\Admin\\Desktop\\qtt搬家\\豐登田園一站式宅配-149275021\\豐登田園一站式宅配-149275021.json";
            String fileResult = "C:\\Users\\Admin\\Desktop\\qtt搬家\\豐登田園一站式宅配-149275021\\豐登田園一站式宅配-149275021 - 副本.json";
